...
// Pull Google Fonts and wp_head hooks (needed for Elementor)
?><!DOCTYPE html>
...
<div class="mbc-screen" id="mbc-screen">
  ...
  <div class="mbc-hero-panel" id="mbc-hero-panel">
    ...
    <!-- Navigation — built from WordPress menus -->
    <nav class="mbc-nav">
    ...
    <!-- Hero content — edit this page in Elementor to control what appears here -->
    <div class="mbc-hero-content">
      ...
      <!-- #5: Plan Your Visit removed. #6: Find Out More launches carousel -->
      <div class="mbc-ctas">
        ...
        <div class="mbc-carousel-track-wrap">
          ...
          <div class="mbc-carousel-track" id="mbc-carousel-track">
            ...
            <a class="mbc-carousel-card" href="<?php echo esc_url( home_url( '/about/' ) ); ?>">
              ...
              <div class="mbc-cc-body">
                <h3>About Us</h3>
                <p>Who we are, what we believe, and what makes MBC tick.</p>
              </div>
            </a>
            ...
            <a class="mbc-carousel-card" href="<?php echo esc_url( home_url( '/church-life/' ) ); ?>">
              ...
              <div class="mbc-cc-body">
                <h3>Church Life</h3>
                <p>Small groups, activities, and community life at MBC.</p>
              </div>
            </a>
            ...
            <a class="mbc-carousel-card" href="<?php echo esc_url( home_url( '/posts/' ) ); ?>">
              ...
              <div class="mbc-cc-body">
                <h3>Latest News</h3>
                <p>Stories, updates and reflections from our community.</p>
              </div>
            </a>
            ...
            <a class="mbc-carousel-card" href="https://www.youtube.com/@MoortownBaptistChurch" target="_blank" rel="noopener">
              ...
              <div class="mbc-cc-body">
                <h3>Watch Online</h3>
                <p>Catch up on Sunday services and special events on YouTube.</p>
              </div>
            </a>
            ...
            <a class="mbc-carousel-card" href="<?php echo esc_url( home_url( '/contact-us/' ) ); ?>">
              ...
              <div class="mbc-cc-body">
                <h3>Get in Touch</h3>
                <p>Questions? Planning a visit? We'd love to hear from you.</p>
              </div>
            </a>
            ...
            <a class="mbc-carousel-card" href="https://www.facebook.com/MoortownBaptistChurch" target="_blank" rel="noopener">
              ...
              <div class="mbc-cc-body">
                <h3>Follow Us</h3>
                <p>Join our Facebook community for news, prayer and events.</p>
              </div>
            </a>
    ...
    <!-- Services strip — edit via Customizer or hardcode below -->
    ...
    <!-- Hero image controls (shown after image is loaded) -->
